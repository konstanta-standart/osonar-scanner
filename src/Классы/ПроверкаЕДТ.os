...
Процедура ОчиститьРабочийКаталог() Экспорт
	
	// Рабочий каталог может сразу не очистится, принудительно очищаем его еще раз
	Если ФС.КаталогСуществует(ПолныйПутьКРабочейОбласти) Тогда
