...
Процедура ВыполнитьПроверкуСПомощьюЕДТ()
	...
	Команда.ДобавитьПараметр("--workspace-location " + ОбернутьВКавычки(каталогРабочейОбласти.ПолноеИмя));
	Команда.ДобавитьПараметр("--project-list " + ОбернутьВКавычки(каталогПроекта.ПолноеИмя));
	Команда.ДобавитьПараметр("--file " + ОбернутьВКавычки(файлРезультата.ПолноеИмя));
	...
	Команда.ДобавитьПараметр(ОбернутьВКавычки(файлРезультата.ПолноеИмя));
